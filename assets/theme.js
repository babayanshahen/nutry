...
// $('.home-testimonial-slide').on('init', function(event, slick){
//   $('.home-testimonial-slide').show();
// });
$(".home-testimonial-slide").slick({
  dots: true,
 infinite: true,
 speed: 300,
 arrows:false,
...
// $( ".everyCollectionBn" ).click(function() {
//     $(this).addClass("activeBn")
// });

 let bnCollectionUrl = window.location.href

let currentbnUrL= bnCollectionUrl.split(".com")
console.log(currentbnUrL[1])
$('.everyCollectionBn a').each(function(i,e){
  if($(e).attr('href')==currentbnUrL[1]){
    $(e).addClass('activeBn');
  }
})

$(document).ready(function(){
  $(".bn_box").click(function(){
...
const filterClick = document.querySelector(".filterClick")
const myCollections = document.querySelector(".filterDiv")
$(filterClick).click(function(){
   $(transitionDiv).addClass("show")
   $(transitionDiv).append(myCollections)
})

$(transitionDiv).append(`<span class="del"><svg 
aria-hidden="true" 
focusable="false" 
role="presentation" 
...
const del = document.querySelector(".del")
  ...
  $(del).click(function(){
   $(transitionDiv).removeClass("show")
  })
